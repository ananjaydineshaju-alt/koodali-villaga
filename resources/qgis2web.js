...
map.getView().fit([8388309.451741, 1331835.856624, 8416345.254445, 1348878.177315], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">koodali administrative map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (14 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'map of koodali';
            }
